...
new_title = '<p style="font-family:sans-serif; color:White; font-size: 50px;">Store Selection Modelllll</p>'
#st.markdown(new_title, unsafe_allow_html=True)
st.markdown(new_title,unsafe_allow_html=True)
st.header('Basic Details')
store_name=st.text_input('Site/Store Name')
rent=st.number_input('Rent',value=0)
monthly_sales=st.number_input('Monthly Sales',value=0)
...
store_latitude=st.number_input('Store Latitude')
store_longitude=st.number_input('Store Longitude')
st.header('Site Location')
Typee = st.selectbox('Type of Area', ('Urban','Suburban and Rural'))
Box_size =st.number_input('Box Size(in sqft)',value=0)
...
Beam_to_bottom = st.number_input('Beam to bottom(in ft)',value=0)
Facade = st.number_input('Facade(in ft)',value=0)
...
Road_width = st.number_input('Road Width(in ft)',value=0)
...
Household = st.number_input('Household',value=0)
Brands = st.number_input('No. Of Brands (Within 1 km)',value=0)
Hospital = st.number_input('No. of Hospitals (within 1 km)',value=0)
...
Doctor_clinic = st.number_input('No. of Doctors & Clinics (Within 1 km)',value=0)
st.write('\n')
st.header('Competetion')
Total_retail_pharmacy = st.number_input('No. of Organized retail pharmacy & 24x7',value=0)
Distance_retail_pharmacy = st.number_input('Distance from Organized retail pharmacy(in metres)',value=0)
Total_medicals = st.number_input('Number of Local Medical shops',value=0)
Distance_medicals = st.number_input('Distance from Local Medical shops(in metres)',value=0)
Supermarket_distance = st.number_input('Supermarket Distance(in metres)',value=0)
Discounted_pharmacy = st.number_input('Discounted Pharmacy Distance(in metres)',value=0)
...
if (result):
    ...
    if Final_Score>=400 :
        titlee = '<p style="font-family:sans-serif; color:#7CFC00; font-size: 50px;">Total Score</p>'
        st.markdown(titlee,unsafe_allow_html=True)
    ...
    elif 300<=Final_Score<=399:
        titlee = '<p style="font-family:sans-serif; color:#87CEFA; font-size: 50px;">Total Score</p>'
        st.markdown(titlee,unsafe_allow_html=True)
        #st.header('Total Score')
        Final_Score=int(Final_Score)
        strr=str(Final_Score)+'/'+str(Total_score)
        ...
        Final_Score=int(Final_Score)
        strr=str(Final_Score)+'/'+str(Total_score)
        titlee2 = f'<p style="font-family:sans-serif; color:#FFA500; font-size: 50px;">{strr}</span></p>'
        st.markdown(titlee2,unsafe_allow_html=True)
        
    elif Final_Score<200:
        titlee = '<p style="font-family:sans-serif; color:#FF0000; font-size: 50px;">Total Score</p>'
        st.markdown(titlee,unsafe_allow_html=True)
        #st.header('Total Score')
        Final_Score=int(Final_Score)
        strr=str(Final_Score)+'/'+str(Total_score)
